  ...
  return (
    ...
    <div className="features-section">
      <div className="feature">
        <img src="benefit1.png" alt="Benefit 1" className="feature-image" />
      ...
      <div className="feature">
        <img src="benefit2.png" alt="Benefit 2" className="feature-image" />
      ...
      <div className="feature">
        <img src="benefit3.png" alt="Benefit 3" className="feature-image" />
